...
from plane_legend import PlaneLegendWidget
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.plane_legend = PlaneLegendWidget(self)
        self.legend_layout.addWidget(QLabel("Plane Legend"))
        self.legend_layout.addWidget(self.plane_legend)
