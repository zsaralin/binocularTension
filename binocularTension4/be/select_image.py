...
# Function to send filenames to the server
...
# Function to process movement and determine stable positions
def get_image(point, image_width, image_height):
    ...
    if movement_id == prev_movement_id:
        ...
        stable_x_pos, stable_y_pos = x_pos, y_pos
